...
from deformable_convolution import ConvOffset2D
...
class Generator(nn.Module):
    def __init__(self, n_residual_blocks, upsample_factor):
        ...
        self.conv1 = nn.Conv2d(5, 64, 3, stride=1, padding=1)

        self.ref_net = ConvOffset2D(2)
        ...
        for i in range(self.upsample_factor // 2):
            self.add_module('upsample' + str(i + 1), Upsampler(n_feats))
